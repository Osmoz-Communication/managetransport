    ...
    <div className="container mx-auto px-4 max-w-7xl">
      ...
      <div className="text-center mb-20">
        <div 
          ...
          data-aos-delay="100"
          data-aos-offset="0"
          className="inline-block px-4 py-2 bg-primary/10 text-primary font-semibold rounded-full text-sm mb-6 tracking-wider uppercase"
        >
          Nos Expertises
        </div>
        <h2 
        ...
        >
          Nous vous accompagnons sur tous les aspects de votre logistique et de votre transport, de l'audit à la mise en œuvre opérationnelle.
        </p>
      </div>
        ...
        {missions.map((mission, i) => (
          <Link key={mission.slug} href={`/nos-missions/${mission.slug}`} className="group">
            <div
              ...
              data-aos-offset="0"
              className="relative bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden h-full hover:shadow-2xl hover:-translate-y-2 hover:border-primary/20"
              style={{
