    ...
    <section className="w-full bg-white py-16 flex flex-col items-center">
      <div className="w-full max-w-4xl px-4 mx-auto">
        <div data-aos="zoom-in" className="bg-white rounded-xl shadow-2xl p-10 flex flex-col items-center text-center" style={{boxShadow: '0 8px 64px 0 rgba(0,0,0,0.08)'}}>
          ...
          <Link data-aos="zoom-in" data-aos-delay="400" href={getLocalizedPath('contact', lang)} className="bg-blue-400 hover:bg-blue-500 text-white font-semibold px-12 py-4 rounded-full text-lg transition-colors">Nous contacter</Link>
        </div>
      </div>
    </section>
  );
