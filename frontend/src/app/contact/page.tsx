          ...
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Partagez-nous votre projet et nous vous recontacterons
                rapidement
              </p>
            </div>
              ...
              >
                ...
                <div className="md:col-span-3 text-center mt-6">
                  <button
                    ...
                    className="group inline-flex items-center px-8 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary/90 transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                  >
                    {isSubmitting ? (
                      <>
                        <svg
